...
infra_k8s_id = is_k8s.add('https://k8s.local', infra_group, 'K8s cluster')

#
# S3 infrastructure service.
#
is_s3 = InfraServiceS3(nuvla)
infra_s3_id = is_s3.add('https://s3.local', infra_group, 'S3')
...
infra_registry = is_registry.add('https://private.registry',
