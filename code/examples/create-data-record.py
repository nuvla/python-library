...
data_record = {'infrastructure-service': 'infrastructure-service/1'}
...
#
# infrastructure-service should be a valid resource ID.
data_record = {
    "description": "Elephants in Zoo",
    "name": "Elephant",

    "object": "elephant.png",
    "bucket": "zoo",
    "content-type": "zoo/elephant",

    "bytes": 12499950,
    "platform": "S3",
    "infrastructure-service": "infrastructure-service/771fa0f1-a38d-400b-bad4-3f7600f069af",

    "tags": ["zoo", "africa", "elephants"]

    # "location": [ 67.4209976196289, 26.389999389648438, 325.7900085449219 ],
    # "timestamp": "2020-04-08T06:33:08Z",
}
dr_id = dr_api.add(data_record)
print('data record:', dr_id)
